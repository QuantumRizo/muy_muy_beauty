...
\begin{titlepage}
  ...
  {\color{white}\LARGE\bfseries ROL: EMPLEADO}\\[1cm]
...
\begin{notabox}
Tu usuario solo da acceso a: \textbf{Agenda, Clientes, Asistencia, Venta Directa} y \textbf{Caja}. Las secciones de análisis, inventario y configuración son exclusivas del administrador.
\end{notabox}
...
\begin{notabox}
Es normal que haya pequeñas diferencias por redondeos. Si la diferencia es significativa, comunícala al administrador antes de cerrar.
\end{notabox}
...
\begin{center}
  ...
  \textcolor{gris}{\small MUYMUY Beauty Studio --- Manual de Empleado v1.0}\\
