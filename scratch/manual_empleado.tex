...
\begin{enumerate}[leftmargin=*]
  ...
  \item Tu columna en la Agenda mostrará un bloqueo automático de \textbf{1 hora}.
  \item No necesitas registrar tu regreso; el sistema te pondrá disponible automáticamente al pasar la hora.
\end{enumerate}
\end{pasobox}
...
\begin{description}[leftmargin=0pt]
  ...
  \item[\textbf{¿Por qué no veo los botones de bloquear horario?}]
    Los botones de bloqueo manual son exclusivos de administradores. Para bloquear tu horario por comida, usa \textbf{Ir a Comer} en Asistencia (dura 1 hora).
\end{description}
